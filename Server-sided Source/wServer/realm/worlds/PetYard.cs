...
namespace wServer.realm.worlds
{
    public class PetYard : World
    {
        ...
        public PetYard(Player player)
        {
            this.player = player;
            Name = "Pet Yard";
            ClientWorldName = "White Bag Feeder";
            Background = 0;
            Difficulty = 3;
            ShowDisplays = true;
            AllowTeleport = false;
        ...
        protected override void Init()
        {
            ...
            {
                case 1: petYard = "wServer.realm.worlds.maps.petyard.jm"; break;
                case 2: petYard = "wServer.realm.worlds.maps.petyard.jm"; break;
                case 3: petYard = "wServer.realm.worlds.maps.petyard.jm"; break;
                case 4: petYard = "wServer.realm.worlds.maps.petyard.jm"; break;
                case 5: petYard = "wServer.realm.worlds.maps.petyard.jm"; break;
            }
