...
namespace wServer.realm
{
    public abstract class World : IDisposable
    {
        ...
        public const int XP_ID = -15;
        public const int SPAWN_ID = -16;
        ...
        {
            return !(this is Nexus) && !(this is GameWorld) && !(this is ClothBazaar) && !(this is Test) && !(this is GuildHall) && !(this is Tutorial) && !IsLimbo;
        }
