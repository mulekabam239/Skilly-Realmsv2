    ...
    partial class BehaviorDb
    {
        private _ Midland = () => Behav()
            ...
            .Init("Wasp Queen",
                ...
                new ItemLoot("GoSnoopyHP", 0.15),
                new ItemLoot("GoSnoopyMP", 0.07)
            )
            .Init("Worker Wasp",
                new State(
            ...
            .Init("Black Bat",
                ...
                new ItemLoot("GoSnoopyHP", 0.01),
                new ItemLoot("GoSnoopyMP", 0.01),
            ...
            .Init("Horned Drake",
                ...
                new ItemLoot("GoSnoopyHP", 0.09),
                new ItemLoot("GoSnoopyMP", 0.12)
            )
            .Init("Drake Baby",
                new State(
                    new DropPortalOnDeath("Forest Maze Portal", 20, PortalDespawnTimeSec: 100),
