    ...
    partial class BehaviorDb
    {
        ...
        .Init("Dr Terrible",
            new State(
                ...
                new Threshold(0.1,
                    new ItemLoot("Scepter of Fulmination", 0.012),
                    new ItemLoot("Robe of the Mad Scientist", 0.012),
                    new ItemLoot("Experimental Ring", 0.012),
                    new ItemLoot("Conducting Wand", 0.012),
                    new ItemLoot("Wine Cellar Incantation", 0.005),
                    new ItemLoot("Golden Nut", 0.01),
                    new ItemLoot("Golden Bolt", 0.01),
                    new ItemLoot("Gleaming Fetish", 0.012),
                    new ItemLoot("War-Forged Staff", 0.012),
                    new ItemLoot("Pride's Staff", 0.012),
                    new ItemLoot("Staff of Spire", 0.012),
