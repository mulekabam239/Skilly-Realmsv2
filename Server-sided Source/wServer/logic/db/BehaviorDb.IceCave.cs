    ...
    partial class BehaviorDb
    {
        ...
        .Init("ic Loot Balloon",
            new State(
                ...
                new Threshold(0.1,
                    new ItemLoot("Staff of Esben", 0.012),
                    new ItemLoot("Skullish Remains of Esben", 0.012),
                    new ItemLoot("Wit of Terror", 0.012),
                    new ItemLoot("Sentient Staff", 0.003),
                    new ItemLoot("The Robe of Twilight", 0.003),
                    new ItemLoot("Ancient Spell: Pierce", 0.003),
                    new ItemLoot("The Forgotten Ring", 0.003),
                    new ItemLoot("Quintain", 0.012),
                    new ItemLoot("Pact of the Talon", 0.012),
                    new ItemLoot("Oath of Giants", 0.012),
