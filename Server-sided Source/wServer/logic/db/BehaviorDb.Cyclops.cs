    ...
    partial class BehaviorDb
    {
        private _ Cyclops = () => Behav()
            ...
            .Init("Cyclops",
                ...
                new ItemLoot("Studded Leather Armor", 0.012),
                new ItemLoot("GoSnoopyHP", 0.05)
            )
            .Init("Cyclops Warrior",
                ...
                new ItemLoot("Golden Shield", 0.012),
                new ItemLoot("GoSnoopyHP", 0.05)
            )
            .Init("Cyclops Noble",
                new State(
                ...
                new ItemLoot("Golden Dagger", 0.012),
                new ItemLoot("Studded Leather Armor", 0.012),
                new ItemLoot("GoSnoopyHP", 0.05)
            )
            .Init("Cyclops Prince",
                ...
                new ItemLoot("Mithril Dagger", 0.012),
                new ItemLoot("Plate Mail", 0.012),
            ...
            .Init("Cyclops King",
                ...
                new ItemLoot("Golden Sword", 0.012),
                new ItemLoot("Mithril Armor", 0.012),
                new ItemLoot("GoSnoopyHP", 0.05)
            )
            ;
    }
