    ...
    partial class BehaviorDb
    {
        private _ Events = () => Behav()
            ...
            .Init("Skull Shrine",
                ...
                new Threshold(0.05,
                    ...
                    new ItemLoot("Orb of Conflict", 0.012),
                    new ItemLoot("Lime Dagger", 0.012),
                    new ItemLoot("Vampire Forged Ring", 0.012),
                    new ItemLoot("Chaos Forged Ring", 0.007)
                )
            )
            .Init("Red Flaming Skull",
                new State(
                    new EntityNotExistsTransition("Skull Shrine", 100, "Despawn"),
                    new Prioritize(
                        new Wander(.6),
                        new Follow(.6, 20, 3)
                        ),
        ...
        #region Hermit God
            ...
            .Init("Hermit God Drop",
                ...
                new Threshold(0.05,
                    new ItemLoot("Helm of the Juggernaut", 0.007)
                )
            );
            #endregion
    }
