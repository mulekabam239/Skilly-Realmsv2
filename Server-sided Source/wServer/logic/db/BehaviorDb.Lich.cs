    ...
    partial class BehaviorDb
    {
        private _ Lich = () => Behav()
            ...
            .Init("Actual Lich",
                ...
                new ItemLoot("GoSnoopyHP", 0.4),
                new ItemLoot("GoSnoopyMP", 0.4)
            )
            .Init("Phylactery Bearer",
                ...
                new ItemLoot("Tincture of Defense", 0.012),
            ...
            .Init("Haunted Spirit",
                ...
                new ItemLoot("GoSnoopyMP", 0.012),
                new ItemLoot("Ring of Magic", 0.012),
                new ItemLoot("Ring of Attack", 0.012),
                new ItemLoot("Tincture of Dexterity", 0.06),
                new ItemLoot("Tincture of Mana", 0.09),
                new ItemLoot("Tincture of Life", 0.007)
            )
            .Init("Mummy",
                new State(
                    new Prioritize(
            ...
            .Init("Mummy Pharaoh",
                ...
                new ItemLoot("Hell's Fire Wand", 0.012),
                new ItemLoot("Slayer Staff", 0.012),
                new ItemLoot("Golden Sword", 0.012),
