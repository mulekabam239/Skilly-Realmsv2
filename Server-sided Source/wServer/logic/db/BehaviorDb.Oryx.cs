        ...
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Vest of Sky Nets", 0.012),
                    new ItemLoot("Feline's Ring", 0.012),
                    new ItemLoot("Tunic of Frozen Hells", 0.012),
                    new ItemLoot("Birth of the Immortals", 0.012),
                    new ItemLoot("Tribute of the Cataclysm", 0.012),
                    new ItemLoot("Legendary Food", 0.09),
                    new ItemLoot("Batteplate of Fallen", 0.012),
                    new ItemLoot("Judgement Tunic of Dread", 0.012),
                    new ItemLoot("Destroyer of Denial", 0.012),
                    new ItemLoot("Hauberk of the Ghost", 0.012),
                    new ItemLoot("Glimmering Breast Plate", 0.012),
