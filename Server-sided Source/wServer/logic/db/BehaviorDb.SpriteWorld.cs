    ...
    partial class BehaviorDb
    {
        ...
        .Init("Limon the Sprite God",
             new State(
                ...
                new Threshold(0.1,
                    new ItemLoot("Staff of Extreme Prejudice", 0.012),
                    new ItemLoot("Cloak of the Planewalker", 0.012),
                    new ItemLoot("Wine Cellar Incantation", 0.005),
                    new ItemLoot("Buckler of Dust Clouds", 0.012),
                    new ItemLoot("Slash of Heaven", 0.012),
                    new ItemLoot("Dragonfly-Cutter", 0.012),
                    new ItemLoot("Earthfire Wand", 0.012),
