    ...
    partial class BehaviorDb
    {
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                ...
                new Threshold(0.1,
                    new ItemLoot("Bow of the Morning Star", 0.012),
                    new ItemLoot("Doomed Ring", 0.012),
                    new ItemLoot("Doom Silk Armour", 0.012),
                    new ItemLoot("amon Doom Trap", 0.012),
