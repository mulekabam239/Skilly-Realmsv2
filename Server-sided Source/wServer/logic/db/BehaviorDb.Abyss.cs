        ...
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Demon Blade", 0.012),
                    new ItemLoot("Bow of Demonic Possession", 0.012),
                    new ItemLoot("Quiver of a Thousand Lost Souls", 0.012),
                    new ItemLoot("Demon armour of Amon", 0.012),
                    new ItemLoot("Medium Food", 0.2),
                    new ItemLoot("Horns of Lucifer", 0.007)
                )
            )
            ...
            .Init("Demon Mage of the Abyss",
                ...
                new ItemLoot("Fire Nova Spell", 0.012),
                new Threshold(0.1,
            ...
            .Init("Brute Warrior of the Abyss",
                ...
                new ItemLoot("Spirit Salve Tome", 0.012),
                new Threshold(0.5,
