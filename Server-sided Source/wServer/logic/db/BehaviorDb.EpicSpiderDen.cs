        ...
        private _ EpicSpiderDen = () => Behav()
            .Init("Son of Arachna",
                 ...
                 new Threshold(0.32,
                    ...
                    new ItemLoot("Gold-Coated Armor", 0.012),
                    new ItemLoot("Masked Face", 0.012),
                    new ItemLoot("Santa Hat", 0.012),
                    new ItemLoot("Vine Dagger", 0.012),
                    new ItemLoot("Rich Food", 0.2),
                    new ItemLoot("Red Blood Dagger", 0.012),
